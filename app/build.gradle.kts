...
gradle.taskGraph.whenReady {
    fun Task.isBaselineProfileGeneratedReleaseTask(): Boolean {
        return name.contains("BaselineProfile", ignoreCase = true) ||
            name.contains("BenchmarkRelease", ignoreCase = true) ||
            name.contains("NonMinifiedRelease", ignoreCase = true)
    }

    val hasReleaseTaskRequiringKeystore = allTasks.any { task ->
        task.name.contains("Release", ignoreCase = true) &&
            !task.isBaselineProfileGeneratedReleaseTask()
    }
