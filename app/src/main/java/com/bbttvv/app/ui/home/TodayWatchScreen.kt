...
internal fun TodayWatchScreen(
    ...
    val requestContentFocus = remember(selectedMode, onContentRowFocused, isHomeTabActive) {
        {
    ...
    DisposableEffect(focusCoordinator, requestContentFocus, isHomeTabActive) {
